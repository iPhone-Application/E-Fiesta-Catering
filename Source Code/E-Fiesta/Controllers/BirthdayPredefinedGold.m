...
@interface BirthdayPredefinedGold ()

@end

@implementation BirthdayPredefinedGold
...
- (void)viewDidLoad {
    ...
    [arrdrink addObject:[NSArray arrayWithObjects:@"Mud Soda",@"Chocolate milk, ice cream and root beer",@"mud-sodas.png", nil]];
    ...
    [arreatery addObject:[NSArray arrayWithObjects:@"Veg Manchurian",@"Indo chinese starter dish of fried veg balls in a spicy, sweet and tangy sauce",@"veg manchurian.png",nil]];
